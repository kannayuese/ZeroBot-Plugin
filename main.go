...
func init() {
	...
	// 默认昵称
	adana := flag.String("n", "Admin", "Set default nickname.")
	...
	config.Z = zero.Config{
		NickName:      append([]string{*adana}, "Admin", "月色"),
...
func main() {
	...
	// 帮助
	zero.OnFullMatchGroup([]string{"/help", ".help", "菜单", "功能"}, zero.OnlyToMe).SetBlock(true).
